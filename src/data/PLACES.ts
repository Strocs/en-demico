...
export const PLACES: Places = {
  guayacan: {
    ...
    place: 'Coquimbo',
    description: 'El proceso de esta ilustración me hizo sentir como si estuviese armando un enorme puzzle. Al principio tenía una imagen clara en mi cabeza, que luego traspase en 2 bocetos, aun así, me faltaban ordenar ciertos elementos, lo que me obligó a investigar y visitar aquella zona. \n Una vez estudiadas las formas más importantes según mi visión, armé aquel espacio de tal manera que las estructuras se acompañaran y equilibraran en el dibujo, tomando elementos de distintas épocas para restaurar y dejar en evidencia las condiciones del lugar simultáneamente. \n Me gustaría agregar dos detalles, el primero es que traté de utilizar colores provenientes de la tierra y de diversos minerales para conectarme con la historia de la iglesia y su entorno. El segundo, es que utilicé como motor una sensación de soledad que me entregó las visitas realizadas tanto en mi infancia como en el presente, algo frío, pero con mucha vida en el interior.',
    color: '#10597d',
    latitude: 1,
    longitude: 1,
  ...
  culebron: {
    ...
    place: 'Coquimbo',
    description: 'En esta ilustración me centré mucho en las formas caóticas y armónicas que entregaba la naturaleza del lugar, separando por secciones aquello que correspondía a la vegetación, el estero, agua, montañas y cielo, pero también la presencia urbana, que de alguna forma cierra y aísla al humedal.\n Las aves jugaron un papel fundamental ya que son fieles compañeras de este ecosistema y aunque me habría gustado agregar una mayor variedad no pude evitar sentir que la mayor parte del protagonismo se lo llevaban las gaviotas, aun así, me tomé la libertad de dibujar como elemento principal a la Garza, transmitiendo el anhelo de acercarse lo más posible a esta mística ave. \n Finalmente utilicé al cielo para realizar una doble referencia entre el mar que de alguna forma siempre se hace presente (brisa, sonido de las olas, y el mismo paisaje) y las aves, ya que entre las líneas de las nubes insinué tanto el vuelo de estas como las ondas del océano.',
    color: '#4a6242',
    latitude: 1,
    longitude: 1,
